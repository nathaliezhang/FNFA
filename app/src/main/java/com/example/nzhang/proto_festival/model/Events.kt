...
data class Events(val events: List<Event>) {
    data class Event(val id: String, val name: String, val description: String, val placeIds: List<Int>, val categoryIds: List<Int>, val startingDate: String, val endingDate: String, val pro: Int) {
